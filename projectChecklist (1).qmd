...
author: Aashray Raut, Joshua Wong
date: 13 Aug. 2025
date-format: 13 08 2025
toc: true
format: pdf
editor: source
---
...
- [x] Identify and use at least 2 data sets/sources.
...
A. QMD line numbers where at least 2 data sources are imported: 7 - 25

## Data Wrangling / Cleaning / etc.

**DO AT LEAST FOUR OF THE FOLLOWING:**

A. QMD line number(s) for general data wrangling: 37 - 85

B. QMD line number(s) for a join operation: 42 - 46

C. QMD line number(s) for `pivot_wider` or `pivot_longer` operation (or equivalent): ---

D. QMD line number(s) for use of regular expressions: 55 - 80

E. QMD line number(s) for use of reduction and/or transformation functions: 55 - 80

F. QMD line number(s) for use of user-defined functions: 56
...
B. QMD line number(s) for multiple different geoms: 151 

C. QMD line number(s) for use of multiple asthetics:  150 - 166

D. QMD line number(s) for use of layered graphics: 150 - 222

E. QMD line number(s) for use of leaflet or choropleth maps: --- We used rnaturalearth

## Tables

A. Include QMD line numbers for **all tables**: 38 - 85, 87 - 90, 92 - 131
